    ...
    <form action="{{ route('languages.translations.index', ['language' => $language]) }}" method="get">
        ...
        <div class="panel">
            ...
            <div class="panel-header">
                 ...
                 {{ config('translation.en.translations') }}
            ...
            <div class="panel-body">
                ...
                @if(count($translations))
                    ...
                    <table>
                        ...
                        <thead>
                            <tr>
                                <th class="w-1/5 uppercase font-thin">{{ config('translation.en.group_single') }}</th>
                                <th class="w-1/5 uppercase font-thin">{{ config('translation.en.key') }}</th>
