...
@if(in_array("10",getUserAccessDetails()))
   ...
   @if(in_array("11",getUserAccessDetails()))
        ...
        @if(in_array("12",getUserAccessDetails()))
          ...
          <li class="nav-item"> <a href="/admin/servicepackagerequest" @if (Route::current()->getName() == "getservicepackagerequestlist") class="nav-link active" @else class="nav-link" @endif> <i class="nav-icon fa fa-flag"></i>
