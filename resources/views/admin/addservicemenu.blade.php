        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">@if ($service_menu_translations['add_servicemenu']) {{$service_menu_translations['add_servicemenu']}} @else Add Service Menu @endif </li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-secondary">
              ...
              <form role="form" method="post" action="{{route('saveservicemenu')}}" enctype="multipart/form-data">
                @csrf
           ...
           <div class="form-row">
            <div class="col">
             <label for="exampleInputEmail1">@if ($service_menu_translations['title']) {{$service_menu_translations['title']}} @else Title @endif</label>
                    <input type="text" class="form-control" id="service_menu_title" name="service_menu_title" placeholder="@if ($service_menu_translations['enter_title']) {{$service_menu_translations['enter_title']}} @else Title @endif" required="required" >
            </div>
           ...
           <div class="form-row">
            <div class="col">
             <label for="exampleInputEmail1">@if ($service_menu_translations['description']) {{$service_menu_translations['description']}} @else Description @endif</label>
                    <textarea class="form-control" rows="6" id="service_menu_description" name="service_menu_description" placeholder="Enter Description" required=""> </textarea>
            </div>
