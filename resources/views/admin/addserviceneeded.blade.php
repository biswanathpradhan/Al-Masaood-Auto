        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">@if ($service_menu_translations['add_service']) {{$service_menu_translations['add_service']}} @else Add Service @endif </li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-secondary">
              ...
              <form role="form" method="post" action="{{route('saveservicebneeded')}}" enctype="multipart/form-data">
                @csrf
           ...
           <div class="form-row">
            <div class="col">
             <label for="exampleInputEmail1">@if ($service_menu_translations['title']) {{$service_menu_translations['title']}} @else Title @endif</label>
                    <input type="text" class="form-control" id="service_needed_title" name="service_needed_title" placeholder="@if ($service_menu_translations['enter_title']) {{$service_menu_translations['enter_title']}} @else Title @endif" required="required" >
            </div>
