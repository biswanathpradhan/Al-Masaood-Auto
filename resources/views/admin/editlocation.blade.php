          ...
          <div class="form-row">
            ...
            <div class="col">
             ...
             <div class="col">
              ...
              <input type="text" class="form-control" id="location_name_ar" name="location_name_ar" placeholder=" الفئة   " required="required" @if($compact_model_val->location_name_ar) value="{{ $compact_model_val->location_name_ar }}"@endif>
            </div>
          </div>
           ...
           <div class="form-row">
            ...
            <div class="col">
             <label for="exampleInputEmail1"> عنوان    </label>
                    <textarea class="form-control" rows="6" id="address_ar" name="address_ar"  placeholder=" عنوان   " required="">@if($compact_model_val->address_ar) {{ $compact_model_val->address_ar }} @endif</textarea>
            </div>
           ...
           <div class="form-row">
            ...
            <div class="col">
             ...
             <div class="col">
                           ...
                           <textarea class="form-control" rows="6" id="available_services_ar" name="available_services_ar"  placeholder=" الرمز البريدي  "  required="">@if($compact_model_val->available_services_ar) {{ $compact_model_val->available_services_ar }} @endif</textarea>
