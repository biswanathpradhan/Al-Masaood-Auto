...
$service_menu_translations = getbackendTranslations('testdrive',null,$language_id);
 ...
 ?> 
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0 text-dark">@if ($service_menu_translations['heading_testdrive']) {{$service_menu_translations['heading_testdrive']}} @else Test Drive @endif </h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">@if ($service_menu_translations['breadcrumb_testdrive']) {{$service_menu_translations['breadcrumb_testdrive']}} @else Test Drive @endif </li>
						</ol>
					</div>
				</div>
				<div class="row mb-2">
