        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">@if ($corporate_translations['add_corporate_solution']) {{$corporate_translations['add_corporate_solution']}} @else Add Corporate Solutions @endif</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">@if ($corporate_translations['add_corporate_solution']) {{$corporate_translations['add_corporate_solution']}} @else Add Corporate Solutions @endif</h3>
              </div>
              <form role="form" method="post" action="{{route('savecorporatesolution')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
          ...
          <div class="form-row">
            ...
            <div class="col">
              ...
              <input type="text" class="form-control" id="corporate_solutions_title" name="corporate_solutions_title" placeholder="@if ($corporate_translations['enter_title']) {{$corporate_translations['enter_title']}} @else Enter Title @endif " required="required">
            </div> 
          </div>
            ...
            <div class="col">
              ...
              <textarea type="text" class="form-control" id="corporate_solutions_description" name="corporate_solutions_description" placeholder="@if ($corporate_translations['enter_description']) {{$corporate_translations['enter_description']}} @else Enter Description @endif " required="required"> </textarea>
            </div>
          </div>
          ...
          <div style="padding-top: 15px;"></div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">@if ($corporate_translations['submit']) {{$corporate_translations['submit']}} @else Submit @endif</button>
