 ...
 ?>  
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0 text-dark">@if ($service_menu_translations['heading_servicepackges']) {{$service_menu_translations['heading_servicepackges']}} @else All Service Packages @endif </h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">@if ($service_menu_translations['heading_servicepackges']) {{$service_menu_translations['heading_servicepackges']}} @else All Service Packages @endif</li>
						</ol>
					</div>
				</div>
				<div class="row mb-2">
          <div class="col-md-2" id="addbtndiv"  >
            <a type="button" class="btn-sm btn-primary" href="{{route('addservicepackage')}}">+ @if ($service_menu_translations['btn_add']) {{$service_menu_translations['btn_add']}} @else Add @endif</a>
          </div>
        </div>
				<div class="row mb-2">
					<div class="col-md-4">
							...
							<table id="example15" class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th>@if ($service_menu_translations['price']) {{$service_menu_translations['price']}} @else Price @endif   </th>
