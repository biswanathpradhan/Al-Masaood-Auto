    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">@if ($customers_translations['breadcrumb_all_customers']) {{$customers_translations['breadcrumb_all_customers']}} @else Customers @endif </li>
            </ol>
          </div>
        </div>
        <div class="row mb-2">
        ...
        <div class="col-md-4">
            <div class="form-group">
              <label>Status</label>
              <select class="form-control select2" name="activestatus_filter" id="activestatus_filter">
                <option selected="selected" value="">All</option>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary card-outline">
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped common-datatable">
                <thead>
                  <tr>
                  ...
                  <th>@if ($customers_translations['mobile_number']) {{$customers_translations['mobile_number']}} @else Mobile Number @endif</th>
                    ...
                    <th width="8%">@if ($customers_translations['lastactive']) {{$customers_translations['lastactive']}} @else Last Active @endif </th>
                     <th width="8%"> Last Active Date </th>
                  </tr>
                </thead>
                <tbody>
