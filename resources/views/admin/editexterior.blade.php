        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">@if ($version_translations['edit_exterior']) {{$version_translations['edit_exterior']}} @else Edit Exteriors @endif </li>
            </ol>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-6">
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">@if ($version_translations['edit_exterior']) {{$version_translations['edit_exterior']}} @else Edit Exteriors @endif</h3> 
              </div>
              <form role="form" method="post" action="{{route('saveexterior')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                      <div class="form-row">    
                      @foreach($car_model_version_exteriors as $image)
                      @php $image_url = asset('images/exterior/'.$image->image_url); @endphp
                      <a href="#" class="pop">

                      <img src="{{ asset('images/exterior/'.$image->image_url) }}" id="{{$image->id}}" data="{{$image->image_url}}" style="height:120px; width:200px"/> 
                      </a>
    ...
    <div class="modal-content">              
      <div class="modal-body">
       ...
       <div class="modal-footer justify-content-between">
          ...
          <button type="button" class="btn btn-primary" id="delete" onclick="return deleteItemexterior(this)">@if ($version_translations['delete']) {{$version_translations['delete']}} @else  Delete @endif</button>
        </div>
    </div>
  </div>
</div>
