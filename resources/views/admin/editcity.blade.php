          ...
          <div class="col-md-6">
            ...
            <div class="col">
             ...
             <label for="exampleInputEmail1">مدينة  </label>
                 <input type="text" class="form-control" id="city_ar" name="city_ar" placeholder="مدينة  " required="required" @if($compact_model_val->city_ar) value="{{ $compact_model_val->city_ar }}"@endif>
            </div>
