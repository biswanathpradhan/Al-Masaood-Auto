        ...
        <div class="row">
          ...
          <div class="form-row">
            ...
            <div class="col">
              ...
              <input type="text" class="form-control" id="location_name_ar" name="location_name_ar" placeholder=" ╪º┘ä┘ü╪ª╪⌐   " required="required">
            </div>
          </div>
           ...
           <div class="form-row">
            <div class="col">
             ...
             <label for="exampleInputEmail1"> ╪╣┘å┘ê╪º┘å  </label>
                    <textarea class="form-control" rows="6" id="address_ar" name="address_ar" placeholder=" ╪╣┘å┘ê╪º┘å   " required=""></textarea>
            </div>
          ...
          <div class="form-row">
            ...
            <div class="col">
                           ...
                           <textarea class="form-control" rows="6" id="available_services_ar" name="available_services_ar" placeholder=" ╪º┘ä╪▒┘à╪▓ ╪º┘ä╪¿╪▒┘è╪»┘è  " required=""></textarea>
