      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="form-row">
            ...
            <div class="col">
              <label for="exampleInputEmail1"> ╪º╪│┘à ╪º┘ä╪Ñ╪╡╪»╪º╪▒ </label>
           ...
           <div class="form-row">
                      ...
                      <div class="col">
              <label for="exampleInputEmail1">@if ($version_translations['search_stock_online_ar']) {{$version_translations['search_stock_online_ar']}} @else  ╪º┘ä╪¿╪¡╪½ ┘ü┘è ╪º┘ä╪ú┘ê╪▒╪º┘é ╪º┘ä┘à╪º┘ä┘è╪⌐ ╪╣┘ä┘ë ╪º┘ä╪Ñ┘å╪¬╪▒┘å╪¬   @endif </label>
