        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-secondary">
              ...
              <form role="form" method="post" action="{{route('savenotification')}}" enctype="multipart/form-data">
                @csrf
                
                    <input type="hidden" class="form-control" id="car_owned_type" name="car_owned_type" value="3">
