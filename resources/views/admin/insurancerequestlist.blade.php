 ...
 ?>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> @if ($insurance_request_translations['heading_insurance_request']) {{$insurance_request_translations['heading_insurance_request']}} @else  Insurance Request @endif</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">@if ($breadcrumb_translations['breadcrumb_insurance_request']) {{$breadcrumb_translations['breadcrumb_insurance_request']}} @else Insurance Request @endif </li>
            </ol>
          </div>
        </div>
        <div class="row mb-2">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary card-outline">
            <div class="card-body">
              <table id="example17" class="table table-bordered table-striped common-datatable">
                <thead>
                  <tr>
    ...
    <div class="modal-content">              
      <div class="modal-body">
       ...
       <div class="modal-footer justify-content-between">
          ...
          <button type="button" class="btn btn-primary" id="addcomment" data-insurance="" data-user="" onclick="return UpdateInsuranceComment(this)">Add</button>
        </div>
