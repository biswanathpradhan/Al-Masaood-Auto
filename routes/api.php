...
Route::get('/car/model-list', 'CustomerController@model_list')->name('customer.model-list');

Route::post('/car/getmodel_list', 'CustomerController@getmodel_list')->name('customer.getmodel_list');
Route::post('/car/getmodel-listsignup', 'CustomerController@getmodel_listsignup')->name('customer.getmodel-listsignup');
...
Route::post('/car/version-list', 'CustomerController@version_list')->name('customer.version-list');
...
Route::post('/services/service-menu', 'ServiceController@getservices')->name('service-menu'); // Get Service Menu

Route::post('/services/service-packages', 'ServiceController@getservicePackages')->name('service-packages'); // Get Service packges
